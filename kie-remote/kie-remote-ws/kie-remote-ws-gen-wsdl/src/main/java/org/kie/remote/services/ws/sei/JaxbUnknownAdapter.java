...
public class JaxbUnknownAdapter extends XmlAdapter<Object, Object> {
    ...
    public Object unmarshal( Object o ) throws Exception {
        ...
        } else if( o instanceof JaxbStringObjectPairArray ) {
            JaxbStringObjectPairArray jsopa = (JaxbStringObjectPairArray) o;
            Map<String, Object> map = new HashMap<String, Object>();
            for( JaxbStringObjectPair keyValue : jsopa.getItems() ) {
