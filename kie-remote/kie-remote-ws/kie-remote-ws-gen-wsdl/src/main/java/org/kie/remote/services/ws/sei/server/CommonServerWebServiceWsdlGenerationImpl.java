...
@WebService(
        ...
        targetNamespace = CommonServerWebService.NAMESPACE)
public class CommonServerWebServiceWsdlGenerationImpl implements CommonServerWebService {

    @Override
    public ServerConfigurationResponse modifyServerConfiguration(ServerConfigurationRequest arg0) throws KieRemoteWebServiceException {
        return null;
    }
