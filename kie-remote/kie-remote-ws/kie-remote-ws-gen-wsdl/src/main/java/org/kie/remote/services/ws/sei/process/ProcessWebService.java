...
public interface ProcessWebService {
    ...
    public ProcessInstanceResponse manageProcess(@WebParam(name = "request", targetNamespace = "") ManageProcessInstanceRequest processInstanceRequest) throws ProcessWebServiceException;

    @WebMethod(action = "urn:ManageProcessInstanceVariables")
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "manageProcessInstanceVariables", targetNamespace = ProcessWebService.NAMESPACE, className = "org.kie.remote.services.ws.wsdl.generated.WrapperManageProcessInstanceVariableRequest")
    @ResponseWrapper(localName = "manageProcessInstanceVariablesResponse", targetNamespace = ProcessWebService.NAMESPACE, className = "org.kie.remote.services.ws.wsdl.generated.WrapperProcessInstanceVariableResponse")
    public ProcessInstanceVariableMessage manageProcessInstanceVariables(@WebParam(name = "request", targetNamespace = "") ProcessInstanceVariableMessage processInstanceRequest) throws ProcessWebServiceException;
