...
public class CommonServerWebServiceException extends KieRemoteWebServiceException {

    /** default serial version UID */
    private static final long serialVersionUID = 2301L;

    public CommonServerWebServiceException(String message, WebServiceFaultInfo faultInfo) {
